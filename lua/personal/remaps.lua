...
-- Window resizing
vim.keymap.set("n", "<C-Down>", "<cmd>resize -2<CR>", { desc = "Shrink window horizontally" })
vim.keymap.set("n", "<C-Up>", "<cmd>resize +2<CR>", { desc = "Wide window horizontally" })
vim.keymap.set("n", "<C-Right>", "<cmd>vertical resize -2<CR>", { desc = "Shrink window vertically" })
vim.keymap.set("n", "<C-Left>", "<cmd>vertical resize +2<CR>", { desc = "Wide window vertically" })
